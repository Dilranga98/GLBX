                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-2 d-grid mb-3">
                                <button class="btn btn-outline-primary shadow-none">Search</button>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card mb-3 col-12 col-lg-9">
                                        <div class="row g-0">
                                            ...
                                            for ($i = 0; $i < $cn; $i++) {
                                                ...
                                                $sellerrs = Database::search("SELECT * FROM `users` WHERE `email`='" . $pr["user_email"] . "' ");
                                            ...
                                            ?>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" title="<?php echo $pr["title"]; ?>" data-bs-content="<?php echo $pr["description"];?>">
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="text-black-50">Color : <?php echo $color_d["name"]; ?></span> &nbsp;| <span class="text-black-50">Condition : <?php echo $condition_d["name"]; ?></span><br>
                                                        ...
                                                        <input type="text" value="<?php echo $cr["qty"]; ?>" class="border border-1 border-secondary fw-bolder px-3 text-start" style="width: 50px; outline: none;"><br>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="row mt-4">
                                                        <div class="col-md-10 offset-md-1 d-grid">
                                                            <button class="btn btn-sm btn-outline-success shadow-none">Buy Now</button>
                                                        </div>
                                    ...
                                    <div class="col-12 col-lg-3">
                                        <div class="row">
                                            ...
                                            <div class="col-12 d-grid mt-3 mb-5">
                                                <button class="btn btn-sm btn-primary fs-6 fw-bold shadow-none">CHECKOUT</button>
                                            </div>
