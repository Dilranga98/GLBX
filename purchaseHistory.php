...
<head>
    ...
    <title>e-Shop | Transaction History</title>
        ...
        <div class="row">
            ...
            ?>
                ...
                ?>
                    ...
                    ?>
                        <div class="co-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-2 bg-info text-white p-4 text-center">
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="card-text"><b>Seller :</b> <?php echo $sellerd["fname"]; ?></span><br>
                                ...
                                <div class="col-12 col-lg-1 bg-info text-white pt-4 text-center">
                    ...
                    <div class="offset-lg-9 col-lg-3 d-none d-lg-block text-end d-lg-grid mb-3">
