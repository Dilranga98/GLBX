                                ...
                                <div class="row">
                                        ...
                                        <ul>
                                            ...
                                            ?>
                                                    <li class="d-flex flex-column justify-content-center align-items-center border border-1 border-secondary">
                                                        <img src="<?php echo $d["code"]; ?>" style="cursor: pointer;" height="150px" id="pimg<?php echo $x; ?>" onclick="loadmainimg(<?php echo $x; ?>);">
                                                        <img src="<?php echo $d["code2"]; ?>" style="cursor: pointer;" height="150px" id="pimg<?php echo $x; ?>" onclick="loadmainimg(<?php echo $x; ?>);">
                                                        <img src="<?php echo $d["code3"]; ?>" style="cursor: pointer;" height="150px" id="pimg<?php echo $x; ?>" onclick="loadmainimg(<?php echo $x; ?>);">
                                                    </li>
                                                <?php
                                    ...
                                    <div class="col-lg-4 order-2 order-lg-2 d-none d-lg-block">
                                        <div class="align-items-center border border-1 border-secondary p-3">
                                            <div class="" style="background-image: url('<?php echo $img1; ?>'); background-repeat: no-repeat; background-size: contain; height: 420px;"></div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="row">
                                                                    <div class="border border-1 border-secondary rounded overflow-hidden float-start position-relative product_qty">
                                                                        ...
                                                                        <input id="qtyinput" class="d-block border-0 fs-6 fw-bold text-start pe-2" type="text" min="1" pattern="[0-9]*" value="1">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row p-2">
                                            ...
                                            $mhb_rs = Database::search("SELECT * FROM `model_has_brand` WHERE `id` = '" . $pd["model_has_brand_id"] . "' ");
                                            $mhb_d = $mhb_rs->fetch_assoc();

                                            $brand_rs = Database::search("SELECT * FROM `brand` WHERE `id` = '" . $mhb_d["brand_id"] . "' ");
                                            $brand_d = $brand_rs->fetch_assoc();

                                            $model_rs = Database::search("SELECT * FROM `model` WHERE `id` = '" . $mhb_d["model_id"] . "' ");
                                            $model_d = $model_rs->fetch_assoc();


                                            $brandsid = Database::search("SELECT * FROM `product` LEFT JOIN `model_has_brand`
                                             ON product.model_has_brand_id = model_has_brand.id LEFT JOIN   `images` ON images.product_id = product.id WHERE `brand_id` LIKE '" . $brand_d["id"] . "' LIMIT 4");
                                            ...
                                            ?>
                                                ...
                                                <div class="card col-10 offset-1 col-md-3 offset-md-0">

                                                    <img src="<?php echo $bdf["code"]; ?>" class="card-img-top">
                                                    <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-10">
                                                <label class="form-label"><?php echo $model_d["name"]; ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 bg-white">
                                        <div class="row g-1">
                                            <div class="col-12 col-lg-4 border border-1 border-danger rounded">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <span class="fs-6 fw-bold text-primary">dilranga</span>
                                                    </div>
                                                    <div class="col-12">
