                        ...
                        <div class="row">
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="col-12">
                                        <select class="form-select shadow-none" id="br" disabled>
                                            ...
                                            $mbid = Database::search("SELECT * FROM `model_has_brand` WHERE `id`= '" . $product["model_has_brand_id"] . "'; ");
                                            $mbd = $mbid->fetch_assoc();

                                            $bid = Database::search("SELECT * FROM `brand` WHERE `id`= '" . $mbd["brand_id"] . "'; ");
                                            $bd = $bid->fetch_assoc();
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="row p-2">
                                    ...
                                    <div class="col-12">
                                        <select class="form-select shadow-none" id="mo" disabled>
                                            <?php

                                            $mid = Database::search("SELECT * FROM `model` WHERE `id`= '" . $mbd["model_id"] . "'; ");
                                            $md = $mid->fetch_assoc();
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="row">
                                    ...
                                    <div class="offset-lg-1 col-12 col-lg-3 form-check ms-2">
                                        <input class="form-check-input" type="radio" name="flexRadioDefault1" id="bn" checked disabled>
                                        <label class="form-check-label" for="bn">
                                            <?php

                                            $crs = Database::search("SELECT * FROM `condition` WHERE `id`= '" . $product["condition_id"] . "'; ");
                                    ...
                                    <!-- <div class="offset-lg-1 col-12 col-lg-3 form-check ms-2">
                                        <input class="form-check-input" type="radio" name="flexRadioDefault1" id="us" disabled>
