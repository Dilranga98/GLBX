            ...
            <div class="row">
                ...
                <div class="col-md-3 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                        ...
                        <span class="fw-bold"><?php echo $u["fname"] . " " . $u["lname"]; ?></span>
                    ...
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6 g-2">
                                ...
                                <input id="fname" type="text" class="form-control shadow-none" placeholder="First name" value="<?php echo $u["fname"]; ?>">
                            </div>
                            <div class="col-md-6 g-2">
                                <label class="form-label">Surname</label>
                                <input id="lname" type="text" class="form-control shadow-none" placeholder="Last name" value="<?php echo $u["lname"]; ?>">
                            </div>
                            <div class="col-md-12 g-2">
                                <label class="form-label">Mobile Number</label>
                                <input id="mobile" type="text" class="form-control shadow-none" placeholder="Enter phone number" value="<?php echo $u["mobile"]; ?>">
                            </div>
                            <div class="col-md-12 g-2">
