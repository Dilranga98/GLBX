            ...
            ?>
                <div class="col-12 border border-1 border-secondary rounded">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-2 border border-2 border-start-0 border-top-0 border-bottom-0 border-primary">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <div class="card-body">
                                                            ...
                                                            <span class="text-black-50">Colour : <?php echo $color_d["name"]; ?></span> |&nbsp;<span class="text-black-50">Condition : <?php echo $condition_d["name"]; ?></span><br>
